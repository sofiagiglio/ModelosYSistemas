...
class Pantalla:
    def __init__(self):
        ...
        self.ventana.config(bg = "steelblue1")
        ...
        f3 = tkinter.Frame(self.ventana)
        f3.grid(column=1, row=0)
        
        self.f4 = tkinter.Frame(self.ventana, bg = "steel blue")
        ...
        self.f9 = tkinter.Frame(self.f8, bg = "steel blue")
        self.f9.grid(column=0, row=0)
        f10 = tkinter.Frame(self.f8)
        f10.grid(column=1, row=0)
        self.f11 = tkinter.Frame(self.f8, bg = "steel blue")
        ...
        self.boton4.pack()
        boton5 = tkinter.Button(self.f1, text = "Servidor", padx = 38, pady = 10)
        boton5.grid(column=0, row=0)
        boton6 = tkinter.Button(self.f1, text = "Cliente", padx = 38, pady = 10)
        boton6.grid(column=1, row=0)
        
        self.etiqueta1 = tkinter.Label(self.f9, text = f'NOMBRE: {self.j1.nombre}', bg = "steel blue")
        self.etiqueta1.pack()
        self.etiqueta2 = tkinter.Label(self.f9, text = f'DAÑO: {self.j1.danio}', bg = "steel blue")
        self.etiqueta2.pack()
        self.etiqueta3 = tkinter.Label(self.f9, text = f'VIDA: {self.j1.vida}', bg = "steel blue")
        self.etiqueta3.pack()
        self.etiqueta4 = tkinter.Label(self.f9, text = f'VELOCIDAD: {self.j1.velocidad}', bg = "steel blue")
        self.etiqueta4.pack()
        self.etiqueta5 = tkinter.Label(self.f9, text = f'PUNTOS: {self.j1.puntos}', bg = "steel blue")
        self.etiqueta5.pack()
        self.etiqueta6 = tkinter.Label(self.f11, text = "", bg = "steel blue")
        self.etiqueta6.pack()
        self.etiqueta7 = tkinter.Label(f3, text = "IP: ")
        self.etiqueta7.grid(column=0, row=0)
        self.etiqueta8 = tkinter.Label(f3, text = "Puerto: ")
