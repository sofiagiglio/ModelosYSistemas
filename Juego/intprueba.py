...
class Pantalla:
    def __init__(self):
        ...
        self.ventana.config(bg = "lightblue1")
        ...
        self.boton4.pack()
        boton5 = tkinter.Button(f12, text = "Servidor", padx = 50, pady = 20)
        boton5.pack(side = tkinter.LEFT)
        boton6 = tkinter.Button(f13, text = "Cliente", padx = 50, pady = 20)
        boton6.pack(side = tkinter.LEFT)
